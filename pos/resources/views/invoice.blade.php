        ...
        <div class="col">
            <div class="card" style="min-height: 85vh">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col"><h4 class="font-weight-bold">ICEBOX CAFE</h4></div>
                        <div class="col"><a class="btn btn-primary float-right btn-sm" onclick="window.print()"><i class="fas fa-print"></i> Print</a>
                        <a href='/transaction' class="btn btn-success float-right btn-sm"><i class="fas fa-arrow-left"></i> Back</a>
                    </div>
                    </div>                 
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <table width="100%" class="table table-borderless">
                                <tr>
                                    ...
                                    <td width="60%" class="font-weight-bold">{{$Transaction->invoice_number}}</td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-sm-6">
                            <table width="100%" class="table table-borderless">
                                <tr>
                                    <td width="38%">Pay</td>
                                    <td width="2%">:</td>
                                    <td width="60%">Rp{{ number_format($Transaction['pay'],2,',','.') }}</td>
                                </tr>
                                <tr>
                                    <td width="38%">Total</td>
                                    <td width="2%">:</td>
                                    <td width="60%">Rp{{ number_format($Transaction['total'],2,',','.') }}</td>
                                </tr>   
                                <tr>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-striped table-sm" width="100%">
                                ...
                                <tbody>
                                @foreach ($ProductTransaction as $index=>$item)
                                        <tr>
                                            <td>{{$index+1}}</td>
